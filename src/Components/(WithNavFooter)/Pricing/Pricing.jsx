  ...
  return (
    <div className="bg-neutral-50 py-32">
      <div className="container mx-auto">
        <SectionTitle
          Heading={"Choose a plan to fit your needs"}
        ></SectionTitle>
        <div className="">
          <ConfigProvider
            theme={{
            ...
            <div className="border-0 border-b-2 ">
              <div className="flex flex-col lg:flex-row gap-10 lg:gap-0 justify-center items-center my-20 p-5">
                <div>
                  <Card
                    title="Basic"
                    className="md:w-96 text-center uppercase "
                  >
                    <h1 className="text-5xl text-neutral-500">£59.99</h1>
                    <p>5 GB of space</p>
                    <p>5 user</p>
                    <p>24/7 support</p>
                ...
                <div className="-mt-2">
                  <Card
                    title="Premium"
                    className="md:w-96 md:h-[450px] text-center uppercase shadow-md shadow-neutral-300"
                  >
                    <h1 className="text-5xl text-neutral-500">£99.99</h1>
                    <p>Unlimited space</p>
                    <p>15 user</p>
                    <p>24/7 support</p>
                    <p>Safe, reliable backup</p>
                ...
                <div>
                  <Card
                    ...
                    className="md:w-96 text-center uppercase"
                  >
                    <h1 className="text-5xl text-neutral-500">£29.99</h1>
                    <p>1 GB of space</p>
                    <p>1 user</p>
                    <p>24/7 support</p>
                    <p>Safe, reliable backup</p>
