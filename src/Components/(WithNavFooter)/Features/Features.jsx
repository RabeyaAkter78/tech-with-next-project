        ...
        >
          <Row gutter={[48, 48]} justify="center" className="my-20">
            <Col xs={24} sm={12} md={12} lg={8} xl={8} xxl={8}>
              <Card
                hoverable
                cover={<Image alt="feature images" src={AllImages.feature1} />}
              >
            ...
            <Col xs={24} sm={12} md={12} lg={8} xl={8} xxl={8}>
              <Card
                hoverable
                cover={<Image alt="feature images" src={AllImages.feature2} />}
              >
            ...
            <Col xs={24} sm={12} md={12} lg={8} xl={8} xxl={8}>
              <Card
                hoverable
                cover={<Image alt="feature images" src={AllImages.feature3} />}
              >
            ...
            <Col xs={24} sm={12} md={12} lg={8} xl={8} xxl={8}>
              <Card
                hoverable
                cover={<Image alt="feature images" src={AllImages.feature4} />}
              >
            ...
            <Col xs={24} sm={12} md={12} lg={8} xl={8} xxl={8}>
              <Card
                hoverable
                cover={<Image alt="feature images" src={AllImages.feature5} />}
              >
            ...
            <Col xs={24} sm={12} md={12} lg={8} xl={8} xxl={8}>
              <Card
                hoverable
                cover={<Image alt="feature images" src={AllImages.feature6} />}
              >
